<div class="modal fade" id="editContactModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form role="form" name="" action="{{ route('update-contact-save') }}" method="POST" enctype="multipart/form-data" class="form-horizontal software-style-label">
            @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-dark float-right"><i class="fa fa-plus" aria-hidden="true"></i> Update Contact</button>
                </div><!-- Modal footer -->
            </form>
        </div>
    </div>
