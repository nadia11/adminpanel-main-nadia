        ...
        <div class="col-10">
            <div class="email-content box box-info animated fadeInRight" style="background: none;">
                <div class="box-header with-border" style="background: #ffffff;">
                    <h2 class="box-title">Trash:: <em style="font-weight: normal; font-size: initial; color: #202124;">Messages that have been in Trash more than 30 days will be automatically deleted.</em></h2>
                    <div class="box-tools float-right">
                        <button type="button" class="btn btn-link empty-trash" data-toggle="tooltip" data-placement="top" title="Delete Email permanently. It never recover.">Empty Trash now</button>
                    </div>
                </div><!-- /.box-header -->

                <div class="box-body" style="padding: 0;">
                    <table class="table table-custom email-content" id="email-trash-table">
                        <tbody>
