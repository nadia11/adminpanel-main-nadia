<div class="modal fade" id="showNewFareModal">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Create New Fare</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <form role="form" name="" action="{{ route('new-fare-save') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="create_fare" class="btn btn-dark float-right"><i class="fa fa-plus" aria-hidden="true"></i> Create New Fare</button>
                </div><!-- Modal footer -->
            </form>
        </div>
    </div>
