<div class="modal fade" id="newCommissionModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Create New Commission</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <form role="form" name="" action="{{ route('new-commission-save') }}" method="post" enctype="multipart/form-data" class="form-horizontal software-style-label">
            @csrf
