<div class="modal fade" id="newAssetModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form role="form" name="" action="{{ route('new-asset-save') }}" method="post" enctype="multipart/form-data" class="form-horizontal software-style-label">
            @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-dark float-right" tabindex="9"><i class="fa fa-plus" aria-hidden="true"></i> Create New Asset</button>
                </div><!-- Modal footer -->
            </form>
        </div>
    </div>
