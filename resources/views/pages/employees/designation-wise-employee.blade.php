...
<section class="content">
    <div class="box box-success animated fadeInRight">
        <div class="box-header with-border">
            <h2 class="box-title">Designation wise Employee List</h2>
            ...
            <table id="general_datatable" class="table table-custom">
                ...
                @foreach($all_employee_info as $employee)
                    <tr id="{{ $employee->employee_id }}" class="animated slideInUp">
                        ...
                        <td style="text-align: left;"><img src="<?php if(!empty($employee->employee_photo)){ echo upload_url( $employee->employee_photo ); }else{ echo image_url('defaultAvatar.jpg'); } ?>" style="border-radius: 50%; width: 30px; height: 30px; border: 1px solid #eee; box-shadow: 0 0 3px rgba(0,0,0,.3); padding: 1px;" />{{ $employee->employee_name }}</td>
