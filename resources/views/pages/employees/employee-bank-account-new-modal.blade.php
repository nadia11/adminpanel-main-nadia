<div class="modal fade" id="newBankAccountModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Create New Employee Bank Account</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <form role="form" name="" action="{{ route('new-employee-bank-account-save') }}" method="POST" enctype="multipart/form-data" class="form-horizontal software-style-label">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="url" name="website" id="website" class="form-control" placeholder="Website" tabindex="8" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control" placeholder="E-mail" tabindex="9" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="phone" id="phone" class="form-control" placeholder="Phone" tabindex="10" required />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="alt_phone" id="alt_phone" class="form-control" placeholder="Alt Phone" tabindex="11" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <textarea id="bank_note" name="bank_note" class="form-control" placeholder="Note" rows="2" tabindex="12"></textarea>
                    </div>
                </div>
            </div><!-- Modal Body -->
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="create_bank" id="create_bank" class="btn btn-dark float-right" tabindex="13"><i class="fa fa-plus" aria-hidden="true"></i> Create New Bank</button>
            </div><!-- Modal footer -->
