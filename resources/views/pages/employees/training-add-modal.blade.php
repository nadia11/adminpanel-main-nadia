    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Add Training Information of Mr. {{ $employee_data->employee_name }}</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <form role="form" name="add_employee_training_form" id="add_employee_training_form" action="{{ route('add-employee-training') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="add_employee_training" id="add_employee_training" class="btn btn-dark float-right" tabindex="7"><i class="fa fa-plus" aria-hidden="true"></i> Create New Training</button>
