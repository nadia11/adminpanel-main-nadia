    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Add Education Information of Mr. {{ $employee_data->employee_name }}</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <form role="form" name="add_employee_edu_form" id="add_employee_edu_form" action="{{ route('add-employee-education') }}" method="POST" enctype="multipart/form-data" class="form-horizontal software-style-label">
                @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="add_employee_education" id="add_employee_education" class="btn btn-dark float-right" tabindex="7"><i class="fa fa-plus" aria-hidden="true"></i> Create New Employee</button>
