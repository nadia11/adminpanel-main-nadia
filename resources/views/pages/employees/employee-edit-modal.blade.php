<div class="modal fade" id="editEmployeeModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form role="form" name="edit_employee" id="edit_employee" action="{{ route('edit-employee') }}" method="POST" enctype="multipart/form-data" class="form-horizontal software-style-label">
            @csrf
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="employee_photo_prev" id="employee_photo_prev">
                    <button type="button" class="btn btn-outline-dark mr-auto" data-dismiss="modal">Close</button>
                    <button type="submit" name="update_employee" id="update_employee" class="btn btn-dark float-right" tabindex="7"><i class="fa fa-plus" aria-hidden="true"></i> Update Employee</button>
                </div><!-- Modal footer -->
            </form>
        </div>
    </div>
