    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Create New Vehicle Type</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <form role="form" name="" action="{{ route('new-vehicle-type-save') }}" method="POST" enctype="multipart/form-data" class="form-horizontal software-style-label">
            @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-dark float-right"><i class="fa fa-plus" aria-hidden="true"></i> Create New Vehicle Type</button>
                </div><!-- Modal footer -->
            </form>
        </div>
    </div>
