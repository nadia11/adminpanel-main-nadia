<div class="modal fade" id="editReferralModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form role="form" name="" action="{{ route('edit-referral-save') }}" method="POST" enctype="multipart/form-data" class="form-horizontal software-style-label">
            @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="update_referral" id="update_referral" class="btn btn-dark" tabindex="7"><i class="fa fa-plus" aria-hidden="true"></i> Update Referral</button>
                </div><!-- Modal footer -->
            </form>
        </div>
    </div>
