<div class="modal fade" id="showNewNewsModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form role="form" name="" action="{{ route('new-news-save') }}" method="POST" enctype="multipart/form-data" class="form-horizontal software-style-label">
            @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="create_news" class="btn btn-dark float-right"><i class="fa fa-plus" aria-hidden="true"></i> Save</button>
                </div><!-- Modal footer -->
            </form>
        </div>
    </div>
