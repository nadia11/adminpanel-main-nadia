            ...
            <div class="modal-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td style="width: 1%;">:</td>
                        <td style="width: 34%;" class="driver_name text-capitalize"></td>
                        <td style="max-width: 3px; border: none; background: #F0F0F0;"></td>

                        <th style="width: 15%;">Driver Status</th>
                        <td style="width: 1%;">:</td>
                        <td style="width: 34%;" class="driver_status text-capitalize"></td>
                    </tr>
                    <tr>
                        <th>Mobile</th>
                        <td>:</td>
                    ...
                    <tr>
                        <th>Country</th>
                        <td>:</td>
                        <td class="country_name text-capitalize"></td>
                        <td style="border: none; background: #F0F0F0;"></td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td class="branch_address text-capitalize"></td>
                        <td style="border: none; background: #F0F0F0;"></td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td class="driving_licence"><var></var><div class="float-right attachment-btn"><a href="" class="btn btn-sm" download> <i class="fa fa-cloud-download-alt"></i> Driving Licence</a></div></td>
                    </tr>
                    <tr>
                        <th>Gender</th>
                        <td>:</td>
                ...
                <table class="table table-bordered table-summery">
                    ...
                    <tbody>
                        <tr style="height: 50px">
                            <td class="vehicle_type"></td>
                            <td class="seat_capacity"></td>
                            <td class="vehicle_color"></td>
                            <td class="manufacturer"></td>
                            <td class="model_year"></td>
                            <td class="vehicle_model"></td>
                            <td class="vehicle_reg_number"></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="table table-bordered table-summery">
                    ...
                    <tbody>
                        <tr style="height: 50px">
                            <td class="vehicle_tax_token"></td>
                            <td class="tax_renewal_date"></td>
                            <td class=""></td>
                            <td class="insurance_number"></td>
                            <td class="insurance_renewal_date"></td>
                            <td class=""></td>
                            <td class="fitness_certificate"></td>
                        </tr>
                    </tbody>
                </table>

                <table class="table table-bordered table-summery">
                    <caption>Current Year Earnings Report - {{ date('Y') }}</caption>
                    <thead>
                        <tr>
