<div class="modal fade" id="newBankAccountModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form role="form" name="" action="{{ route('new-bank-account-save') }}" method="POST" enctype="multipart/form-data" class="form-horizontal software-style-label">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="percent" id="percent" maxlength="13" class="form-control" placeholder="Percent %" tabindex="9" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <textarea id="bank_note" name="bank_note" class="form-control" placeholder="Note" rows="1" tabindex="14"></textarea>
                    </div>
                </div>
            </div><!-- Modal Body -->
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="create_bank" id="create_bank" class="btn btn-dark float-right" tabindex="16"><i class="fa fa-plus" aria-hidden="true"></i> Create New Bank</button>
            </div><!-- Modal footer -->
