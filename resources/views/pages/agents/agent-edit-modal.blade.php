<div class="modal fade" id="editAgentModal">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form role="form" name="" action="{{ route('edit-agent-save') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            @csrf
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="agent_photo_prev" id="agent_photo_prev">
                    <input type="hidden" name="trade_licence_prev" id="trade_licence_prev">
                    <input type="hidden" name="tin_certificate_prev" id="tin_certificate_prev">
                    <input type="hidden" name="vat_certificate_prev" id="vat_certificate_prev">
