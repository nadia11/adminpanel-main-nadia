<div class="modal fade" id="newUserModal" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('new-user-save') }}" method="post" enctype="multipart/form-data" class="form-horizontal software-style-label" role="form">
            @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="datetime" name="dob" id="dob" placeholder="Date of Birth" class="form-control" required="required" autocomplete="off" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="button" class="btn btn-warning show_password" tabindex="-1"><i class="fa fa-eye" title="Show Password"></i> <span class="text"></span></button>
                                <button type="button" class="btn btn-info" id="gen_password" tabindex="-1"><i class="fa fa-sync-alt fa-spin" title="Password Generator"></i></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between" style="padding: 5px 0; margin: 25px 15px 10px; border-top: 1px solid #DDE; border-bottom: 1px solid #DDE;">
                        ...
                        <div class="custom-control custom-switch" style="white-space: nowrap;">
                            <input type="checkbox" class="custom-control-input" id="ip_access" name="ip_access">
                            <label class="custom-control-label" for="ip_access" style="cursor:pointer;">Active IP Access</label>
                        </div>
                    </div>
